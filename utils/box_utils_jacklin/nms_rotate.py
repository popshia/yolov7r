...
def nms_rotate_cpu(boxes, scores, iou_threshold, max_output_size=500000):
        ...
        for _j in range(_i + 1, num):
            ...
            try:
                ...
                if int_pts is not None:
                    ...
                    if (area_r1 + area_r2 - int_area) <= 0: inter = 0.0
                    else: inter = int_area * 1.0 / (area_r1 + area_r2 - int_area)
